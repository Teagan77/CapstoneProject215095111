...
public class CustomerRepositoryImplTest {
    ...
    Customer updatedFirstCust = custBuilder.getCustomer(id, phone, age, updatedName, surname, credit, gender, membership);
    Customer firstCust = custBuilder.getCustomer(id, phone, age, name, surname, credit, gender, membership);
    Customer secondCust = custBuilder.getCustomer(id2, phone2, age2, name2, surname2, credit2, gender2, membership2);
    ...
    public void update() {
        ...
        Assert.assertEquals("Jeffrey", this.custRepository.read(updatedFirstCust.getCustId()).getName());
        this.custRepository.removeAll();
    }
