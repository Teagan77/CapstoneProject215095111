...
public class EmployeeRepositoryImplTest {
    ...
    public void update() {
        ...
        assertEquals("Eric", this.employeeRepositoryImpl.read(updatedFirstEmp.getId()).getName());
        this.employeeRepositoryImpl.removeAll();
    }
    ...
    public void delete() {
        ...
        this.employeeRepositoryImpl.delete(firstEmp.getId());

        assertEquals(null, this.employeeRepositoryImpl.read(firstEmp.getId()));
        this.employeeRepositoryImpl.removeAll();
    }
    ...
    public void read() {
        this.employeeRepositoryImpl.create(firstEmp);
        assertEquals(true, this.employeeRepositoryImpl.read(firstEmp.getId()) instanceof Employee);
        System.out.println(this.employeeRepositoryImpl.read(firstEmp.getId()));
        this.employeeRepositoryImpl.removeAll();
    }
