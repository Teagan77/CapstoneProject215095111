...
//        return this.customerRepositoryImpl.getAll().iterator().next();
    ...
    public void c_update() {
        ...
        Customer updatedCust = new Customer.Builder().copy(getSaved()).custLastName(newSurname).build();
    ...
    public void e_delete() {
        ...
        this.customerRepositoryImpl.delete(savedCust.getcustomerID());
        d_getAll();
    }
    ...
    public void b_read() {
        Customer savedCust = getSaved();
        Customer readCust = this.customerRepositoryImpl.read(savedCust.getcustomerID());
