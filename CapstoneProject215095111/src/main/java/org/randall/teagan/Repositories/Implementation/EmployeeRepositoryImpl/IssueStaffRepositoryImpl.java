...
import org.randall.teagan.Repositories.RepositoryInterfaces.EmployeeRepositoryInterface.IssueStaffRepository;
import org.springframework.stereotype.Repository;

import java.util.ArrayList;

@Repository("IssueStaffRepository")
public class IssueStaffRepositoryImpl implements IssueStaffRepository {
    ...
    public static IssueStaffRepositoryImpl getIssueStaffRepositoryImpl(){
    ...
    public IssueStaff read(String id) {
        ...
        for(int i = 0;i < issueStaffs.size();i++) {
            ...
            if (issueStaffs.get(i).getIssuerNo().equals(id)) {
                index = i;
                exists = true;
            }
        }
